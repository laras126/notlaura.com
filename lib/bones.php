...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		// typekit
		// wp_register_script( 'notlaura-typekit', '//use.typekit.net/xqo8pio.js', array(), '', false );
		...
		wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/assets/css/main.480d.min.css', array(), '', 'all' );
		...
		// for development
		wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/assets/js/build/scripts.d9fc.min.js', array( 'jquery' ), '', true );
